...
// ServeListener 在已绑定的 listener 上阻塞地提供 WebSocket 服务
func ServeListener(ln net.Listener, m *Manager, prog *logx.ProgramLog) {
...
func serveBot(conn *websocket.Conn, m *Manager, prog *logx.ProgramLog) {
	...
	m.Register(b)
	b.blog.Sys("上线 %s 名称=%s 系统=%s", b.Addr(), b.NameOrDash(), b.OSOrDash())
